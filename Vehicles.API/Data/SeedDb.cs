...
namespace Vehicles.API.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckProceduressAsync();
        }

        private async Task CheckProceduressAsync()
        {
            if (!_context.Procedures.Any())
            {
                ...
                _context.Procedures.Add(new Procedure { Price = 10000, Description = "Alineación de carburador" });
                ...
                _context.Procedures.Add(new Procedure { Price = 10000, Description = "Cambio de llanta delantera" });
                _context.Procedures.Add(new Procedure { Price = 10000, Description = "Cambio de llanta trasera" });
                _context.Procedures.Add(new Procedure { Price = 10000, Description = "Reparación de motor" });
                _context.Procedures.Add(new Procedure { Price = 10000, Description = "Kit de arrastre" });
                ...
                _context.Procedures.Add(new Procedure { Price = 10000, Description = "Lavado de tanque" });
